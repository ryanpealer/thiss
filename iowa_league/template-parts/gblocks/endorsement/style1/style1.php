...
/**
 * Endorsement Slider - Block Template.
 *
...
$id = 'es-wrapper-' . $block['id'];
if (!empty($block['anchor'])) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$className = 'blck-es-wrapper';
...
$allowed_blocks = array( 'core/heading', 'core/paragraph', 'core/buttons', 'acf/endorsement-slider' );
$template = array(
    ...
    array( 'acf/endorsement-slider', array() )
);
$styleWrap = '';
