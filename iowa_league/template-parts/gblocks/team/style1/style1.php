...
if (get_field('is_example')) :
    echo '<img src="'.get_template_directory_uri() . '/template-parts/gblocks/team/style1/preview.jpg">';
else:

// Create id attribute allowing for custom "anchor" value.
$id = 'team-wrapper-' . $block['id'];
if (!empty($block['anchor'])) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$className = 'blck-team-wrapper';
...
$allowed_blocks = array( 'core/heading', 'core/paragraph', 'core/spacer', 'core/buttons', 'acf/team-listing' );
$template = array(
