...
$id = 'notice-wrapper-' . $block['id'];
if (!empty($block['anchor'])) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$className = 'blck-notice-wrapper';
...
$allowed_blocks = array( 'core/heading', 'core/paragraph', 'core/buttons', 'acf/gblock-spacer' );
$template = array(
...
$styleWrap = '';
$styleWrap .= isset($data['bg_color']) && $data['bg_color'] ? '--section-bg:'.$data['bg_color'].';' : '--section-bg: #EFF4FF;';
