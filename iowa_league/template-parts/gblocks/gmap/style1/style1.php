...
$id = 'gmap-wrapper-' . $block['id'];
if (!empty($block['anchor'])) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$className = 'blck-gmap-wrapper';
...
$allowed_blocks = array( 'core/heading', 'core/paragraph', 'core/spacer', 'core/buttons', 'acf/gmap' );
$template = array(
