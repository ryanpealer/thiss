...
$id = 'services-wrapper-' . $block['id'];
if (!empty($block['anchor'])) {
    $id = $block['anchor'];
}
// Create class attribute allowing for custom "className" and "align" values.
$className = 'blck-services-list';
...
$allowed_blocks = array( 'core/heading', 'core/paragraph', 'acf/gblock-spacer', 'core/buttons', 'acf/services-listing' );
$template = array(
    ...
    array( 'acf/services-listing', array()),
    array( 'acf/gblock-spacer', array() )
);
$styleWrap = '';
